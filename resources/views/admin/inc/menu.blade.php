<div id="menuContainer" @class([''])>
    <div id="mySidenav" @class(['h-dvh sidenav w-0 pt-6 pe-2 uppercase text-sm fixed bg-[#111] overflow-x-auto'])>
        ...
        <a @class(['block text-decoration-none no-underline pt-4 px-4 pb-2 pe-4 mt-4 text-[#818181] hover:text-white hover:bg-[#818181]']) href="{{ route('admin.property.index') }}">propriétés</a>
        ...
        <a @class(['block text-decoration-none no-underline py-4 px-4 text-[#818181] hover:text-white hover:bg-[#818181]']) href="#">Menu 3</a>
        <a @class(['block text-decoration-none no-underline py-4 px-4 text-[#818181] hover:text-white hover:bg-[#818181]']) href="#">Menu 4</a>
    </div>
